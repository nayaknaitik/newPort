    ...
    >
      <div className="max-w-6xl w-full text-center">
        ...
        >
          ...
          robust <span className="font-semibold text-white">back-end APIs</span>{" "}
          to crafting smooth, polished{" "}
          ...
          as my database solution. <br className="hidden md:block" />I also
          build intelligent{" "}
          <motion.span
            initial={{ scale: 0.8, opacity: 0, filter: "blur(4px)" }}
            whileInView={{ scale: 1, opacity: 1, filter: "blur(0px)" }}
